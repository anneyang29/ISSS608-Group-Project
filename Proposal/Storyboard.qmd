...
1.  **H1: Linear Regression (Behavior -> Customer Value)** - Test whether a selected predictor has a statistically significant linear relationship with the selected customer value outcome.

2.  **H2: One-way ANOVA (Spending by Segment)** - Test whether mean spending differs significantly across selected customer groups.

### H1: Regression (Behavior -> Customer Value)

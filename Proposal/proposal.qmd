...
1.  Examine the COFINFAD dataset to derive useful insights to better understand the fintech company's customer base in the following dimensions:
    ...
    1.  Test hypothesis-driven relationships between customer behaviour and business outcomes (for example, whether behavioural indicators significantly predict customer value outcomes, and whether spending differs significantly across customer groups) using confirmatory data analysis.

    2.  Identifying natural segments in the customer base, to inform downstream decision making on resource optimisation and precision marketing towards different customer segments
...
2.  Combine the above insights into an interactive and intuitive to use visual analytics application
...
1.  **Confirmatory Data Analysis**
    ...
    -   Group difference testing (for example, ANOVA or Kruskal-Wallis) to assess whether key metrics differ across customer segments.
...
-   [Clustering Analysis](https://anneyang29.github.io/ISSS608-Group-Project/clustering.html)
-   [Time-oriented Data Analysis](https://anneyang29.github.io/ISSS608-Group-Project/Proposal/time_analysis.html)

Please refer to the respective prototype tabs for details on the R codes to create the outputs for each module.

## Storyboard

Please refer to [Storyboard page](https://anneyang29.github.io/ISSS608-Group-Project/Proposal/Storyboard.html) for details on the planned layouts and types of plots expected for each module.
...
![Gantt chart overview of project tasks and task owners](images/gantt_chart.jpg)
